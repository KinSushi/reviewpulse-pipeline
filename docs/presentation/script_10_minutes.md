...
| 4:40–5:30 | 7 — résultats | F1 macro, AUC, rappel. Trois faits à dire lentement : **125 tests verts**, **26 mutations sur 26 détectées** (en deux passages : 24 à la campagne, 2 au contrôle ciblé qui a suivi les deux correctifs — le dire tel quel), et **deux entraînements successifs donnent le même chiffre à la seizième décimale**. Si le jury demande ce qu'apportent les mutations : deux avaient survécu, l'une montrait que la porte de qualité n'était pas prouvée bloquante, l'autre qu'un test passait pour la mauvaise raison. |
